...
def run():
	...
	while (True):
		...
		elif (event == "day_change" or event == "hour_change") and (valve is not None):
		...
		elif (event == "mode_change" and valve is not None):
